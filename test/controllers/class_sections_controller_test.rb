...
class ClassSectionsControllerTest < ActionController::TestCase
  ...
  test "should create class_section" do
    assert_difference('ClassSection.count') do
      post :create, class_section: { academic_track: @class_section.academic_track, adviser: @class_section.adviser, room_number: @class_section.room_number, section_name: @class_section.section_name }
    end
  ...
  test "should update class_section" do
    patch :update, id: @class_section, class_section: { academic_track: @class_section.academic_track, adviser: @class_section.adviser, room_number: @class_section.room_number, section_name: @class_section.section_name }
    assert_redirected_to class_section_path(assigns(:class_section))
  end
